...
public class RestaurantArrayImplTests {
	...
	public void testRestauranteVacio() throws Exception {
	    ...
	    Assert.assertEquals(res.getActualCapacity(),0);
	...
	public void testOcupa1Mesa() throws Exception{
	    ...
	    Assert.assertEquals(6,res.getActualCapacity());
	...
	public void testGetTotal1plato() throws Exception{
	    ...
	    Assert.assertEquals(20.0,res.getFinalPrice(1),0.0);
	    Assert.assertEquals(20.0,res.getFinalPriceRestaurant(),0.0);    
	}
	...
	public void testGetTotal2platos() throws Exception{
	    ...
	    Assert.assertEquals(30.0,res.getFinalPrice(1),0.0);
	    Assert.assertEquals(30.0,res.getFinalPriceRestaurant(),0.0);    
	}
